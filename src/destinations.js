...
export const destinations = [
  ...
  { id: 'grief', kicker: 'THE GARDEN MAKES ROOM FOR EVERY SEASON', title: 'The Grief Garden', copy: 'A quiet place to remember that grief can deepen compassion without becoming the whole story.', game: 'grief-game', href: 'grief-garden/', lat: -7, lon: -54, art: griefArt, tag: 'sit for a while' },
